...
public final class EndpointProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "/google/cloud/servicedirectory/v1/endpoint.proto\022 google.cloud.servicedirectory"
          + ".v1\032\034google/api/annotations.proto\032\037googl"
          + "e/api/field_behavior.proto\032\031google/api/resource.proto\"\352\002\n"
          + "\010Endpoint\022\021\n"
          ...
          + "ud.servicedirectory.v1.Endpoint.AnnotationsEntryB\003\340A\001\0322\n"
          + "\020AnnotationsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\226\001\352A\222\001\n"
          + "(servicedirectory.googleapis.com/Endpoint\022fproj"
          + "ects/{project}/locations/{location}/name"
          + "spaces/{namespace}/services/{service}/endpoints/{endpoint}B\370\001\n"
          + "$com.google.cloud.servicedirectory.v1B\r"
          + "EndpointProtoP\001ZPgoogle.golang.org/genproto/googleapis/clou"
          + "d/servicedirectory/v1;servicedirectory\370\001\001\252\002"
          + " Google.Cloud.ServiceDirectory.V1\312\002 G"
