...
public final class EndpointProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "4google/cloud/servicedirectory/v1beta1/endpoint.proto\022%google.cloud.servicedire"
          + "ctory.v1beta1\032\037google/api/field_behavior"
          + ".proto\032\031google/api/resource.proto\032\037googl"
          + "e/protobuf/timestamp.proto\032\034google/api/annotations.proto\"\224\004\n"
          + "\010Endpoint\022\021\n"
          ...
          + "ud.servicedirectory.v1beta1.Endpoint.MetadataEntryB\003\340A\001\022@\n"
          + "\007network\030\005 \001(\tB/\340A\005\372A)\n"
          + "\'servicedirectory.googleapis.com/Network\0224\n"
          ...
          + "(servicedirectory.googleapis.com/Endpoint\022fprojects/{project}/locations/{l"
          + "ocation}/namespaces/{namespace}/services/{service}/endpoints/{endpoint}B\365\002\n"
          + ")com.google.cloud.servicedirectory.v1beta1B\r"
          + "EndpointProtoP\001ZUgoogle.golang.org/genproto/googleapis/cloud/servicedirectory/v1b"
          + "eta1;servicedirectory\370\001\001\252\002%Google.Cloud."
          + "ServiceDirectory.V1Beta1\312\002%Google\\Cloud\\"
          + "ServiceDirectory\\V1beta1\352\002(Google::Cloud::ServiceDirectory::V1beta1\352Aa\n"
          + "\'servicedirectory.googleapis.com/Network\0226project"
          + "s/{project}/locations/global/networks/{network}b\006proto3"
    };
    descriptor =
