...
public final class LookupServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.servicedirectory.v1.ResolveServiceRequest,
      com.google.cloud.servicedirectory.v1.ResolveServiceResponse> getResolveServiceMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.servicedirectory.v1.ResolveServiceRequest,
      com.google.cloud.servicedirectory.v1.ResolveServiceResponse> getResolveServiceMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.servicedirectory.v1.ResolveServiceRequest, com.google.cloud.servicedirectory.v1.ResolveServiceResponse> getResolveServiceMethod;
    if ((getResolveServiceMethod = LookupServiceGrpc.getResolveServiceMethod) == null) {
      synchronized (LookupServiceGrpc.class) {
        if ((getResolveServiceMethod = LookupServiceGrpc.getResolveServiceMethod) == null) {
          LookupServiceGrpc.getResolveServiceMethod = getResolveServiceMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.servicedirectory.v1.ResolveServiceRequest, com.google.cloud.servicedirectory.v1.ResolveServiceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ResolveService"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.servicedirectory.v1.ResolveServiceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.servicedirectory.v1.ResolveServiceResponse.getDefaultInstance()))
              .setSchemaDescriptor(new LookupServiceMethodDescriptorSupplier("ResolveService"))
              .build();
        }
      }
    }
  ...
  public static abstract class LookupServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void resolveService(com.google.cloud.servicedirectory.v1.ResolveServiceRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.servicedirectory.v1.ResolveServiceResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getResolveServiceMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class LookupServiceStub extends io.grpc.stub.AbstractAsyncStub<LookupServiceStub> {
    ...
    public void resolveService(com.google.cloud.servicedirectory.v1.ResolveServiceRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getResolveServiceMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class LookupServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LookupServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.servicedirectory.v1.ResolveServiceResponse resolveService(com.google.cloud.servicedirectory.v1.ResolveServiceRequest request) {
   ...
   * </pre>
   */
  public static final class LookupServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LookupServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.servicedirectory.v1.ResolveServiceResponse> resolveService(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RESOLVE_SERVICE:
          serviceImpl.resolveService((com.google.cloud.servicedirectory.v1.ResolveServiceRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.servicedirectory.v1.ResolveServiceResponse>) responseObserver);
          break;
        default:
